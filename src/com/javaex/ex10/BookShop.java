...
public class BookShop {
    ...
    public static void main(String[] args) {
        ...
        num = num-1;//배열이 0부터 시작이고 순번이 1부터 시작이므로 순서를 맞춰줘야한다
        

        // (1) 입력된 번호에 맞는 책을 찾아 대여 되었음(상태코드=0)을 체크 합니다.
        // 코드작성
        System.out.println(books[num].getTitle()+"이(가) 대여되었습니다");
        books[num].rent(0);//books[]별 rent값을 바꾸어 state 상태가 바뀐다
    ...
    //(2)전달받은 배열을 모두 출력하는 메소드// 디스플레이 출려 메소드가 Book에 없고 여기 있음
